document.addEventListener("DOMContentLoaded", () => {
    ...
    const HEADERS = {
        ...
        'Authorization': `Bearer ${BEARER_TOKEN}`  // Agrega el token de autorización en la cabecera
    };
    ...
    function renderMovies(movies, container, limit = movies.length) {
        ...
        movies.slice(0, limit).forEach(movie => {
          ...
          <a href="https://www.themoviedb.org/movie/${movie.id}" target="_blank" rel="noopener noreferrer" onclick="console.log('Clic en Ver Más: https://www.themoviedb.org/movie/${movie.id}')">    
    ...
    async function renderGenresSections() {
        ...
        // Limitar a 3 géneros
        const limitedGenres = genres.slice(0, 3);  // Muestra solo los primeros 3 géneros
